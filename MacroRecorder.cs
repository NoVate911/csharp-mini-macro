    ...
    internal sealed class MacroRecorder
    {
        ...
        private IntPtr MouseProc(int nCode, IntPtr wParam, IntPtr lParam)
        {
            if (nCode >= 0)
            {
                ...
                // Hook coordinates and Win32 virtual-desktop bounds are in the same screen space.
                double normX = _desktop.NormalizeX(ms.pt.x);
                double normY = _desktop.NormalizeY(ms.pt.y);
